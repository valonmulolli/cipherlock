...
Commands for managing and inspecting X25519 encryption keys.

```
cipherlock key [command] [flags]
```
...
* [cipherlock key fingerprint](cipherlock_key_fingerprint.md)	 - Display the SHA-256 fingerprint of a public key
